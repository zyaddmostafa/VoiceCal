...
class _HomeApiService implements HomeApiService {
  ...
  @override
  Future<MealDataResponse> getMealData(MealDataRequest request) async {
  ...
  @override
  Future<UserMealsResponse> getUserMeals(String userId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'user_id': userId};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<UserMealsResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UserMealsResponse _value;
    try {
      _value = UserMealsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
